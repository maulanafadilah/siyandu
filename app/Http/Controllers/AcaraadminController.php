...
class AcaraadminController extends Controller
{
    ...
    {
        return view('dashboard.latest_sales');
    }
    ...
    public function event()
    {
        ...
        return view('dashboard.event', compact('page_title', 'page_description','action','logo','logoText'));
    }
    ...
    public function event_detail()
    {
        ...
        return view('dashboard.event_detail', compact('page_title', 'page_description','action','logo','logoText'));
    }
	    // Customers
    public function customers()
    {
        ...
        return view('dashboard.customers', compact('page_title', 'page_description','action','logo','logoText'));
    }
	    // Analytics
    ...
    public function balita()
    {
        ...
        return view('table.balita', compact('page_title', 'page_description','action'));
    }
	    // UC Nestable.

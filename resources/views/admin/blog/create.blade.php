    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Formulir Tambah Blog</h4>
        </div>
        <div class="card-body">
          <div class="form-validation">
          <form class="form-valide" method="post" action="/blog/" enctype="multipart/form-data">
            @csrf
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                      <input type="file" class="form-control custom-file-input" id="gambar" name="gambar" required>

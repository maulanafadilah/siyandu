...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('images/logo-babydaily.png') }}">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
			...
			@else
                <img class="logo-abbr" src="{{ asset('images/logo-babydaily.png') }}" alt="">
			@endif
			@if(!empty($logoText))
